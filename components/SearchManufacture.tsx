...
import { SearchManufacturePropsType } from "@/types";

const SearchManufacturer:FC<SearchManufacturePropsType> = ({ manufacturer, setManufacturer }: SearchManufacturePropsType) => {
